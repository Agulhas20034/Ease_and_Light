...
export class TranslationService {
  ...
  private translations: Record<string, { pt: string; en: string }> = {
    ...
    nacionalidade: { pt: 'Nacionalidade', en: 'Nationality' },
    tipo: { pt: 'Tipo', en: 'Type' },
    nif: { pt: 'NIF', en: 'NIF' },
    passaporte: { pt: 'Passaporte', en: 'Passport' },
    confirm_password: { pt: 'Confirmar Palavra-passe', en: 'Confirm Password' },
    telefone_invalid: { pt: 'Telefone inválido (mínimo 9 dígitos apenas números)', en: 'Invalid phone (minimum 9 digits, numbers only)' },
    ...
    tipo_peregrino: { pt: 'Peregrino', en: 'Peregrino' },
    tipo_dono_estabelecimento: { pt: 'Dono Estabelecimento', en: 'Establishment Owner' },
    tipo_dono_empresa_transportes: { pt: 'Dono Empresa Transportes', en: 'Transport Company Owner' },
    ...
    adiciona_funcionario: { pt: 'Adicionar Funcionário', en: 'Add Employee' },
    lista_funcionarios: { pt: 'Lista de Funcionários', en: 'Employees' },
    edita_funcionario: { pt: 'Editar Funcionário', en: 'Edit Employee' },
    lista_pedidos: { pt: 'Lista de Pedidos', en: 'Orders' },
    atribui_pedido: { pt: 'Atribuir Pedido', en: 'Assign Order' },
    cria_percurso: { pt: 'Criar Percurso', en: 'Create Route' },
    gere_percurso: { pt: 'Gerir Percursos', en: 'Manage Routes' },
    gere_grupo: { pt: 'Gerir Grupo', en: 'Manage Groups' },
    cria_grupo: { pt: 'Criar Grupo', en: 'Create Group' },
    edita_grupo: { pt: 'Editar Grupo', en: 'Edit Group' },
    lista_mochilas: { pt: 'Lista de Mochilas', en: 'Backpacks' },
    cria_recolha_cliente: { pt: 'Criar Recolha (Cliente)', en: 'Create Collection (Client)' },
    cria_recolha_estafeta: { pt: 'Criar Recolha (Estafeta)', en: 'Create Collection (Courier)' },
    cria_entrega_estafeta: { pt: 'Criar Entrega (Estafeta)', en: 'Create Delivery (Courier)' },
    cria_entrega_cliente: { pt: 'Criar Entrega (Cliente)', en: 'Create Delivery (Client)' },
    regista_mochila: { pt: 'Registar Mochila', en: 'Register Backpack' },
    cria_contas: { pt: 'Criar Contas', en: 'Create Accounts' },
